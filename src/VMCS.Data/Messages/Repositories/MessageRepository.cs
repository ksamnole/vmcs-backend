...
namespace VMCS.Data.Messages.Repositories
{
    public class MessageRepository : IMessageRepository
    {
        ...
        {
            var message = await _applicationContext.Messages.FirstOrDefaultAsync(m => m.Id == id, cancellationToken: token);
        ...
        {
            var entity = await _applicationContext.Messages.FirstOrDefaultAsync(m => m.Id == message.Id, cancellationToken: token);
