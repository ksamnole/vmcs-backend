...
{
    protected readonly IDirectory directory = new Directory("testId", "testName");
    protected readonly TextFile file = new("fileName", "text");
    protected readonly Folder folder = new("testName");

    protected TestBaseCodeSharing()
    {
    }
}
